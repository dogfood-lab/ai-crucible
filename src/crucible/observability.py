...
import :mod:`crucible.scoring` at module load, avoiding a cross-agent
...
from crucible.types import AttemptState, TerminatedBy
...
def wilson_interval(successes: int, n: int, *, z: float = _Z_95) -> WilsonInterval:
    ...
    than imported from :mod:`crucible.scoring` to keep the Wave-1 build free of
...
class ModelProfile:
    ...
    crucible most wants to measure (§8.7).
    """
