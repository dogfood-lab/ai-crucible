...
:class:`crucible.types.TraceEvent`. Per Vivaria (swarm-17 finding 8) the budget
...
an Inspect log writer or persist it via :mod:`crucible.attestation`.
"""
...
from crucible.types import AttemptState, RoleName, Score, TraceEvent
...
class TraceWriter:
    ...
    job of :class:`crucible.attestation.JsonlEventStore`; this class only shapes
    the record.
    """
